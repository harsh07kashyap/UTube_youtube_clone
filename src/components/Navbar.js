...
const Navbar = () => {
    ...
    const fetchProfilePics = async () => {
      try {
        ...
        const response = await axios.get("http://localhost:5000/api/profile/fetchprofilepic", {
      ...
      <nav className="navbar">
        ...
        <div className="navbar-center">
            ...
            {/* <button className="voice-search-btn">
                <img src="https://www.gstatic.com/images/icons/material/system/2x/mic_black_24dp.png" alt="Voice Search"/>
            </button> */}
            </div>

  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(`${backend_url}/api/channel/profiledata/${userid}`);
    ...
    const fetchProfilePics = async () => {
      try {
        // const token = localStorage.getItem("token");
        const response = await axios.get(`${backend_url}/api/channel/fetchprofilepic/${userid}`);
    ...
    const fetchVideoCount = async () => {
      try {
        ...
        const response = await axios.get(
          (`${backend_url}/api/profile/fetchvideocount/${userid}`),
          {
